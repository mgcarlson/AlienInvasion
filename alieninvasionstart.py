...
from alien import GameStats
from ship import Ship
from alien import Bullet
...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("Maddie's Alien Invasion")

        #Create an insatce to store game settings
    ...
    def _check_bullet_alien_collisions(self):
        ...
        if(collisions):
            #icnrememnts the number of aliens hit in settings each time a collision occurs
    ...
    def _update_screen(self):
        ...
        #Displays ships left and aliens hit on screen
        myfont = pygame.font.SysFont("monospace", 32)
        label = myfont.render("Ships left: "+str(self.stats.ships_left + 1)+"    Aliens hit: "+str(self.stats.aliens_hit), 1, (250, 250, 250))
